      ...
      <section id="contact" className="py-20 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Contact Form */}
            <div>
              <h3 className="text-xl font-semibold text-[#5E3023] mb-6">Send us a Message</h3>
              <form onSubmit={handleContactSubmit} className="space-y-6">
                <div>
                  <Label htmlFor="name" className="text-[#895737]">Name</Label>
                  <Input
                    id="name"
                ...
                <div>
                  <Label htmlFor="email" className="text-[#895737]">Email</Label>
                  <Input
                    id="email"
                    type="email"
                ...
                <div>
                  <Label htmlFor="message" className="text-[#895737]">Message</Label>
                  <Textarea
                    id="message"
                ...
                <Button 
                  type="submit"
                  className="bg-[#5E3023] hover:bg-[#895737] text-white w-full py-3 rounded-lg"
                >
                  Send Message
                </Button>
              </form>
